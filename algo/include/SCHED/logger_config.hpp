 ...
 *
 */
#define LOG_DEBUG BOOST_LOG_SEV(sched::log, boost::log::trivial::debug)
/**
 * @brief A macro to log with "info" severity
 *
 */
#define LOG_INFO BOOST_LOG_SEV(sched::log, boost::log::trivial::info)
/**
 * @brief A macro to log with "warning" severity
 *
 */
#define LOG_WARNING BOOST_LOG_SEV(sched::log, boost::log::trivial::warning)
/**
 * @brief A macro to log with "error" severity
 *
 */
#define LOG_ERROR BOOST_LOG_SEV(sched::log, boost::log::trivial::error)

/**
 * @brief A macro to log with "trace" severity
 *
 */
#define LOG_TRACE BOOST_LOG_SEV(sched::log, boost::log::trivial::trace)
namespace sched {
